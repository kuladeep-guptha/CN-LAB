...
# # class GoogleMeetWindow(tk.Frame):
...
# #         # Create the video conference window
# #         self.video_conference_window = tk.Canvas(self.frame, width=640, height=480)
# #         self.video_conference_window.pack()

# #         # Create the meeting controls
# #         self.meeting_controls = tk.Frame(self.frame)
# #         self.meeting_controls.pack()

# #         # Create the meeting code label
# #         self.meeting_code_label = tk.Label(self.meeting_controls, text="Meeting code:")
# #         self.meeting_code_label.pack()

# #         # Create the meeting code entry
# #         self.meeting_code_entry = tk.Entry(self.meeting_controls)
# #         self.meeting_code_entry.pack()

# #         # Create the turn mic on or off button
# #         self.turn_mic_on_or_off_button = tk.Button(self.meeting_controls, text="Turn mic on or off")
# #         self.turn_mic_on_or_off_button.pack()

# #         # Create the turn camera on or off button
# #         self.turn_camera_on_or_off_button = tk.Button(self.meeting_controls, text="Turn camera on or off")
# #         self.turn_camera_on_or_off_button.pack()

# #         # Create the turn captions on or off button
# #         self.turn_captions_on_or_off_button = tk.Button(self.meeting_controls, text="Turn captions on or off")
# #         self.turn_captions_on_or_off_button.pack()

# #         # Create the raise your hand button
# #         self.raise_your_hand_button = tk.Button(self.meeting_controls, text="Raise your hand")
# #         self.raise_your_hand_button.pack()

# #         # Create the leave meeting button
# #         self.leave_meeting_button = tk.Button(self.meeting_controls, text="Leave meeting")
# #         self.leave_meeting_button.pack()

# #         # Create the change settings button
# #         self.change_settings_button = tk.Button(self.meeting_controls, text="Change settings, background, layout, and more")
# #         self.change_settings_button.pack()

# #         # Create the share your screen or give presentations button
# #         self.share_your_screen_or_give_presentations_button = tk.Button(self.meeting_controls, text="Share your screen or give presentations")
# #         self.share_your_screen_or_give_presentations_button.pack()
...
# #     google_meet_window = GoogleMeetWindow(root)
# #     root.mainloop()


# import sys
# from PySide6.QtCore import Qt
# from PySide6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QLabel, QLineEdit, QPushButton, QMessageBox, QComboBox, QDialog, QVBoxLayout
...
#         message_options = QComboBox()
#         message_options.addItems(["One-One", "One-Many"])

#         send_button = QPushButton("Send")
#         layout.addWidget(message_options)
...
#         dialog = QDialog(self)
#         dialog.setWindowTitle("File Options")
#         dialog.setGeometry(100, 100, 300, 150)

#         layout = QVBoxLayout()

#         file_options = QComboBox()
#         file_options.addItems(["One-One", "One-Many"])
